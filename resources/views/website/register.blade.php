        ...
        <form action="/register" method="POST" class="p-3 mt-3">
           @csrf
            <div class="form-field d-flex align-items-center">
                ...
                <input value="{{ old('name') }}" type="text" name="name" id="userName" placeholder="Name">
            </div>
            @error('name')
            ...
            @enderror
             ...
             <div class="form-field d-flex align-items-center">
                <span class="fas fa-key"></span>
                <input value="{{ old('retype_password') }}" type="password" name="retype_password" id="pwd" placeholder="Retype Password">
            </div>
